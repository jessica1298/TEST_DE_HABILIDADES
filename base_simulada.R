# CÓDIGO PARA GENERAR LAS BASES DE DATOS ----------------------------------
...
write.csv(p,'C:/Users/JESSICA/Desktop/TEST-DE-HABILIDADES/pacientes.csv')
...
write.csv(doctor,'C:/Users/JESSICA/Desktop/TEST-DE-HABILIDADES/doctor.csv')
